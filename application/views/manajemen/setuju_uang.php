<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Persetujuan Uang Transportasi</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-3 ml-3" style="width: 100%;">
                            <div class="card-header">
                                <i class="fa fa-address-card mr-2" aria-hidden="true"></i> Forum Persetujuan Uang Transportasi Pegawai</div>
                            <div class="card-body">
                                <table class="table">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th scope="col">Uang Bensin</th>
                                            <th scope="col">Uang Parkir</th>
