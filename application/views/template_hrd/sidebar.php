<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('hrd/dashboard_hrd') ?>">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fa fa-suitcase" aria-hidden="true"></i>
                </div>
                <div class="sidebar-brand-text mx-3" style="font-size: small;">HRD PT. Karline Mastrindo</div>
            </a>
            ...
            <div class="sidebar-heading">
                <i class="fa fa-bullhorn mr-2" aria-hidden="true"></i> HRD
            </div>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url('hrd/uangtransport') ?>">
                    ...
                    <span>Uang Transport Kehadiran</span></a>
            </li>
